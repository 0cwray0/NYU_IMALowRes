...
// let memeText; let memeNameText; let memeImageText; let memeURLText;
...
.then(data => {
  ...
  //console.log(data.memes[0]); //Having issues pulling meme titles out of this array properly...
  ...
  //memeText.innerHTML = memeText[randomTextMeme].title;
...
//    console.log(data.memes[0]);
    //data.memes spits out a proper array now...
//    })
// });
...
/*window.addEventListener("load", function() {
    ...
    .then(data => {
        console.log(data.data.memes);
        memeTextData = data.data.memes;
        randomMeme = Math.floor(Math.random() * data.data.memes.length);
        
        // console.log(memeData[randomMeme].url)
        let memeNameText = document.getElementById("meme_text");
        memeNameText.innerHTML = memeTextData[randomMeme].name;
    
        let memeImageText = document.getElementById("text_read");
        memeImageText.src = memeTextData[randomMeme].url;
    
        memeURLText = memeTextData[randomMeme].url
        p5Title = loadText(memeURLText)
        //console.log(p5Image);
    ...
    //refreshes the meme with the meme button
    let memeTextButton = document.getElementById("textbutton");
    memeTextButton.addEventListener("click", function() {
        ...
        // console.log(memeData[randomMeme].url)
        memeNameText = document.getElementById("meme_text");
        memeNameText.innerHTML = memeTextData[randomMeme].name;
    
        memeImageText = document.getElementById("text_read");
        memeImageText.src = memeTextData[randomMeme].url;
